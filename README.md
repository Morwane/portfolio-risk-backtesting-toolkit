...
![Rolling Sharpe Ratio](docs/images/rolling_sharpe.png)

#### Monthly Returns
Calendar-style monthly performance view, useful for spotting clusters of weak or strong periods.
![Monthly Returns](docs/images/monthly_returns_heatmap.png)
...
#### Stress Testing
Shows portfolio behaviour under historical stress windows and custom risk shocks. Scenarios with no data are excluded rather than shown as zero-return bars.
![Stress Testing](docs/images/stress_comparison.png)
