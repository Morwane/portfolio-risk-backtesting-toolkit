...
## Final LIVE Run Snapshot

| Metric | Value |
|--------|-------|
| Universe validation | 22 primary_ok / 0 fallback_used / 0 unavailable |
| Loaded sleeves | 22 |
| Available sleeves after cleaning | 22 |
| Common history start | 2012-12-13 |
| Portfolio integrity | VALID |
| Dropped target weight | 0.0% |
| Brent crude retained | Yes |
| Tests passing | 86 / 86 ✓ |
...
The chart gallery below shows the main outputs generated by the live LSEG-backed run. Charts are saved under `outputs/charts/` and copied to `docs/images/` for GitHub rendering.

#### Cumulative Performance

Realised NAV path of the executed portfolio after LSEG availability checks and cleaning.

<p align="center">
  <img src="docs/images/cumulative_performance.png" width="900">
</p>

#### Drawdown

Peak-to-trough losses through time, revealing realised downside risk.

<p align="center">
  <img src="docs/images/drawdown.png" width="900">
</p>

#### Rolling Volatility

Annualised portfolio risk evolving through time.

<p align="center">
  <img src="docs/images/rolling_volatility.png" width="900">
</p>
...
<p align="center">
  <img src="docs/images/rolling_sharpe.png" width="900">
</p>

#### Monthly Returns Heatmap

Calendar-style monthly returns identifying clusters of strong or weak months.

<p align="center">
  <img src="docs/images/monthly_returns_heatmap.png" width="900">
</p>

#### Executed Asset Allocation

Actual executed allocation after unavailable sleeves, if any, are removed and weights are renormalised.

<p align="center">
  <img src="docs/images/asset_allocation.png" width="900">
</p>

#### Return / Risk Contribution

Sleeves contributing most to portfolio performance and risk.

<p align="center">
  <img src="docs/images/contribution_bar.png" width="900">
</p>

#### Correlation Heatmap

Diversification structure and correlated exposures across sleeves.

<p align="center">
  <img src="docs/images/correlation_heatmap.png" width="900">
</p>

#### Stress Scenario Comparison

Portfolio behaviour under historical stress windows and custom risk shocks. Scenarios with no data are excluded, not shown as zero-return bars.

<p align="center">
  <img src="docs/images/stress_comparison.png" width="900">
</p>

#### VaR Distribution

Daily return distribution with VaR and Expected Shortfall thresholds to visualise left-tail risk.

<p align="center">
  <img src="docs/images/var_distribution.png" width="900">
</p>

> **Transparency note:** All charts reflect the executed portfolio after LSEG availability checks, cleaning, and any weight renormalisation. If a sleeve is unavailable or excluded, this is disclosed in the run manifest and portfolio integrity reports. All analysis is audit-ready and defensible for investment committees, risk committees, and regulators.
...
### If universe.yaml changed, clear stale cached prices before live rerun

```bash
rm -f data/processed/prices_*.parquet
```
